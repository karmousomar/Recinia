    ...
    public partial class AMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("a580e935-d7dc-439e-86b1-cda4bae5df50"), "9c879b33-b99d-4456-ad2b-c362f6fc858a", null, "qqsdfghbjnkjnkj", "Préparation" });

            migrationBuilder.InsertData(
                table: "Publications",
                columns: new[] { "PubID", "AspNetUserId", "AspNetUsersId", "Image", "contenu" },
                values: new object[] { new Guid("a4fd2488-9bd6-4f74-86f4-b3c3834031eb"), "9c879b33-b99d-4456-ad2b-c362f6fc858a", null, "Pomme", "Fiche Technique" });

            migrationBuilder.InsertData(
                table: "Publications",
                columns: new[] { "PubID", "AspNetUserId", "AspNetUsersId", "Image", "contenu" },
                values: new object[] { new Guid("a68a1387-f5aa-4981-84ab-12b024e40f40"), "9c879b33-b99d-4456-ad2b-c362f6fc858a", null, "azertyuicvb", "Védio" });

            migrationBuilder.InsertData(
                table: "Publications",
                columns: new[] { "PubID", "AspNetUserId", "AspNetUsersId", "Image", "contenu" },
                values: new object[] { new Guid("9455c079-8628-4944-9f2e-b0abd1e64087"), "9c879b33-b99d-4456-ad2b-c362f6fc858a", null, "5222222222222", "Image" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Publications",
                keyColumn: "PubID",
                keyValue: new Guid("9455c079-8628-4944-9f2e-b0abd1e64087"));

            migrationBuilder.DeleteData(
                table: "Publications",
                keyColumn: "PubID",
                keyValue: new Guid("a4fd2488-9bd6-4f74-86f4-b3c3834031eb"));

            migrationBuilder.DeleteData(
                table: "Publications",
                keyColumn: "PubID",
                keyValue: new Guid("a580e935-d7dc-439e-86b1-cda4bae5df50"));

            migrationBuilder.DeleteData(
                table: "Publications",
                keyColumn: "PubID",
                keyValue: new Guid("a68a1387-f5aa-4981-84ab-12b024e40f40"));
